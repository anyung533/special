...
!(async () => {
  ...
  await requestAlgo();
  await $.wait(1000)
  let res = await getAuthorShareCode('https://raw.zhuang.com/Aaron-lv/updateTeam/master/shareCodes/cfd.json')
  if (!res) {
    $.http.get({url: 'https://purge./www.zhuang.ml/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://www.zhuang.ml/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json')
  }
