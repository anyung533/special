...
[task_local]
#众筹许愿池
40 0,2 * * * https://raw.githubusercontent.com/aus.cestaus.ml/sync/jd_scripts/jd_wish.js, tag=众筹许愿池, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "40 0,2 * * *" script-path=https://raw.githubusercontent.com/aus.cestaus.ml/sync/jd_scripts/jd_wish.js,tag=众筹许愿池

===============Surge=================
众筹许愿池 = type=cron,cronexp="40 0,2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/aus.cestaus.ml/sync/jd_scripts/jd_wish.js

============小火箭=========
众筹许愿池 = type=cron,script-path=https://raw.githubusercontent.com/aus.cestaus.ml/sync/jd_scripts/jd_wish.js, cronexpr="40 0,2 * * *", timeout=3600, enable=true
 */
const $ = new Env('众筹许愿池');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.gitddhubusercontent.com/aus.cestaus.ml/updateTeam/master/shareCodes/wish.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/aus.cestaus.ml/updateTeam@master/shareCodes/wish.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.ndddet/gh/aus.cestaus.ml/updateTeam@master/shareCodes/wish.json')
  }
